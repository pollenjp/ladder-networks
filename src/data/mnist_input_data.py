...
class SemiDataSet(object):
    def __init__(self, images, labels, n_labeled):
        ...
        n_from_each_class = n_labeled // n_classes #py3 adapt
        i_labeled = []
...
def read_data_sets(train_dir, n_labeled=100, fake_data=False, one_hot=False):
  ...
  data_sets.train      = DataSet(images=train_images, labels=train_labels, fake_data=False)
  data_sets.validation = DataSet(images=validation_images, labels=validation_labels, fake_data=False)
  data_sets.test       = DataSet(images=test_images, labels=test_labels, fake_data=False)
